...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        return $this->services['App\Service\ApiClientService'] = new \App\Service\ApiClientService(($this->services['jms_serializer'] ?? $this->getJmsSerializerService()));
    }
