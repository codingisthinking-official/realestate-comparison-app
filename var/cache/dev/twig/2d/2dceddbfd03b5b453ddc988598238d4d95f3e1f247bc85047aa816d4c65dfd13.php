...
class __TwigTemplate_d86c5092730b1b420e634df8ff4ace1c648f2470c48edcdd583ddc7037602a53 extends Twig_Template
{
    ...
    <section class='smaller-padding'>
        ...
        // line 39
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new Twig_Error_Runtime('Variable "app" does not exist.', 39, $this->source); })()), "request", []), "uri", []), "html", null, true);
        echo "/&p[images][1]=";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new Twig_Error_Runtime('Variable "app" does not exist.', 39, $this->source); })()), "request", []), "uri", []), "html", null, true);
        echo "/}&p[title]=";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["page"]) || array_key_exists("page", $context) ? $context["page"] : (function () { throw new Twig_Error_Runtime('Variable "page" does not exist.', 39, $this->source); })()), "title", []), "html", null, true);
        ...
        // line 40
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new Twig_Error_Runtime('Variable "app" does not exist.', 40, $this->source); })()), "request", []), "uri", []), "html", null, true);
    ...
    <section class=\"comparision smaller-padding\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["type_list"]) || array_key_exists("type_list", $context) ? $context["type_list"] : (function () { throw new Twig_Error_Runtime('Variable "type_list" does not exist.', 58, $this->source); })()));
        $context['loop'] = [
...
(isset($context["page"]) || array_key_exists("page", $context) ? $context["page"] : (function () { throw new Twig_Error_Runtime('Variable "page" does not exist.', 74, $this->source); })()), "slug", [])]));
        // line 75
        echo "
            </div>
        </div>
...
";
    ...
    {
        return array (  268 => 84,  259 => 83,  246 => 80,  239 => 75,  237 => 74,  236 => 72,  226 => 65,  220 => 61,  201 => 59,  184 => 58,  176 => 53,  169 => 49,  155 => 40,  145 => 39,  136 => 33,  127 => 27,  122 => 25,  117 => 23,  102 => 11,  98 => 10,  92 => 6,  83 => 5,  65 => 4,  47 => 3,  15 => 1,);
    }
    ...
    <section class='smaller-padding'>
        <div class=\"wrapper\">
            <div class=\"row middle-md between-md\">
                ...
                <div class=\"col-xs-12\">
                    <ul class=\"social-media\">
                        <li><a href=\"http://www.facebook.com/sharer/sharer.php?s=100&p[url]={{ app.request.uri }}/&p[images][1]={{ app.request.uri }}/}&p[title]={{ page.title }}&p[summary]=zajawka”\" target=\"_blank\"> <img src=\"{{ asset('images/fb-icon.jpg') }}\" alt=\"facebook\"> </a></li>
                        <li><a href=\"https://twitter.com/intent/tweet?url={{ app.request.uri }}\" target=\"_blank\"> <img src=\"{{ asset('images/tw-icon.jpg') }}\" alt=\"twitter\"> </a></li>
                    </ul>
                </div>
            </div>
        </div>
