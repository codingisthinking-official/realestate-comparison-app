...
/* base.html.twig */
class __TwigTemplate_8d345e499b9fbc8f60c4251b24cee6425d726911ce0a234537b947f2443fe8ba extends Twig_Template
{
    private $source;
...
<body ";
    ...
    <header>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["x"]) {
            // line 43
            echo "                        <li><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['App\Twig\AppExtension']->cityInfo($context["x"], $this->extensions['App\Twig\AppExtension']->findCity($context["x"])), "html", null, true);
            echo "\"> ";
...
<body {% block bodyType %}{% endblock %}>
    <header>
        <div class=\"wrapper\">
            ...
            <nav>
                <ul>{% for x in 1..10 %}
                        <li><a href=\"{{ x|cityInfo(x|findCity) }}\"> {{ x|findCity }} </a></li>
                    {% endfor %}
                </ul>
            </nav>
