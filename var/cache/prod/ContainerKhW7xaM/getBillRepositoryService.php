...
// Returns the private 'App\Repository\BillRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/BillRepository.php';

return $this->privates['App\Repository\BillRepository'] = new \App\Repository\BillRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
